...
//Gambaran Umum Desa Korpri Jaya 
  ...
  textSize(18)
  textFont(PoppinsExtraLight)
  text("Semua lokasi kelurahan ini semula bernama Kelurahan Harapan Jaya yang berasal dari  .",110,1020)
  text("bagian wilayah Sukarame. Kelurahan ini memliliki luas 491 Ha di tetapkan menjadi 2 lingkungan. ",110,1040+r)
  text("Lingkungan 1 terdiri dari 10 RT dan lingkungan 2 terdiri dari 19 RT .",110,1060+2*r)
  text("Berdasarkan Peraturan Daerah Kota Bandar Lampung No.04 tahun 2012 kelurahan ini  ",110,1080+3*r)
  text("dipecah lagi menjadi 2 kelurahan, yaitu :  ",110,1110+4*r)
  text("1. Lingkungan 1 = 10 RT menjadi kelurahan Korpri Jaya",110,1130+5*r)
  text("2. Lingkungan 2 = 19 RT menjadi kelurahan Korpri Raya.",110,1150+6*r)
  text("Kelurahan Korpri Jaya di kembangkan menjadi 2 lingkungan yaitu:",110,1170+7*r)
